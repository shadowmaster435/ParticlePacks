...
public record ConstantAccelerations(Vector3 cardinal, float angular) {
     ...
     * }
     * */
    public static ConstantAccelerations parse(JsonObject object) {
        ...
        return new ConstantAccelerations(cardinal, angular);
    }
